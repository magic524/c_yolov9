...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/root/yolov9_block/models/detect/yolov9-c-DualConv.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / '/root/dataset/VisDrone.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / '/root/yolov9_block/data/hyps/hyp.scratch-high.yaml', help='hyperparameters path')
